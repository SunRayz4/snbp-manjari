    ...
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-xl font-bold mb-4">About SNBP's</h3>
            <p className="text-gray-300 mb-4">
              SNBP's INTERNATIONAL School is committed to providing quality education that nurtures excellence, builds
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-1 mt-0.5 text-secondary" style={{height:'80px' ,width:'55px' ,marginTop:'-20px'}} />
                <span className="text-gray-300">
126/2A Manjri-Keshav Nagar Road, Near Shivkrishna,
Mangal Karyalay, Manjri, Pune - 36.</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-secondary" />
                <span className="text-gray-300"> +91 8956351916 / 8446534553                                              </span>
              </li>
              <li className="flex items-center">
                ...
                <span className="text-gray-300">snbpskeshavnagar@gmail.com</span>
                 ...
                 <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-secondary" />
                <span className="text-gray-300">principalsnbpskeshavnagar@gmail.com</span>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-300">
          <p>© {new Date().getFullYear()} SNBP's INTERNATIONAL School. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
